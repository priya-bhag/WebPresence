...
public class Help {
	...
	@FindBy(xpath =".//*[@id='additional_links']/ul/li[5]/a")
	static WebElement HelpLinkTest;
	...
	@FindBy(xpath = ".//*[@id='mainContent']/table/tbody/tr/td/table/tbody/tr[3]")
	...
	public static void validateProd() throws IOException, InterruptedException {
		...
		Logger log = Logger.getLogger("Help");
