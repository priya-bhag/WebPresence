...
public class Air1 {
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Air1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/air/");

		Helper.capturescreenshot(driver, "AirIN_Test");
		...
		try {
...

			{
				...
				log.info("Left menu items on both urls are same");
			}
		} catch (Exception e) {
