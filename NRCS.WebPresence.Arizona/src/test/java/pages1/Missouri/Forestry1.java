...
public class Forestry1 {

	static WebDriver driver;

	public Forestry1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Forestry1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/landuse/forestry/");

		Helper.capturescreenshot(driver, "ForestryIN_Test");
