...
public class ConservationCompliance1 {

	static WebDriver driver;
	String New_link;

	public ConservationCompliance1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	/*
	 * @FindBy(xpath=
	 * ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h4[1]/img")
	...
	/*
	 * @FindBy(xpath="") static WebElement Image1Test;
	 */
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("ConservationCompliance1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/farmbill/cc/");

		Helper.capturescreenshot(driver, "ConservationComplianceIN_Test");
