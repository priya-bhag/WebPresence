...
public class CulturalResources1 {

	static WebDriver driver;

	public CulturalResources1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("CulturalResources1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/cultural/");

		Helper.capturescreenshot(driver, "CulturalResourcesIN_Test");
