...
public class Agronomy1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/agronomy/");
		 ...
		 * 
		 * 
		 * log.info("Title of Test is " +title2); log.info("\t");
		 * 
		 * 
		 * 
		 ...
		 * 
		 * }else{ log.info("Heading of both Env: are not same");
		 * 
		 * }
		 */
		 ...
		 * 
		 * log.info("Titles of both Env: are same"); }else{
		 * 
