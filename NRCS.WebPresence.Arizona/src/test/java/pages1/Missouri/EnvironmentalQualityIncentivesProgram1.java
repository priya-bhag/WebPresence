...
public class EnvironmentalQualityIncentivesProgram1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/financial/eqip/");

		Helper.capturescreenshot(driver, "EnvironmentalQualityIncentiveProgramIN_Test");
