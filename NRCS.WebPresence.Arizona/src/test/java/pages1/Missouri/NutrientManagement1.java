...
public class NutrientManagement1 {

	static WebDriver driver;

	public NutrientManagement1(WebDriver Idriver) {
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("NutrientManagement1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/nutrient/");

		Helper.capturescreenshot(driver, "NutrientManagement_Test");
