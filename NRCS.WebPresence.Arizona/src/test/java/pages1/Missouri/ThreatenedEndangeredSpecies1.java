...
public class ThreatenedEndangeredSpecies1 {
	static WebDriver driver;

	public ThreatenedEndangeredSpecies1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("ThreatenedEndangeredSpecies1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/threat/");

		Helper.capturescreenshot(driver, "StateTechnicalCommitteeIN_Test");
