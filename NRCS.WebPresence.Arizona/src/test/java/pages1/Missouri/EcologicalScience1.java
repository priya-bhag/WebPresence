...
public class EcologicalScience1 {

	static WebDriver driver;

	public EcologicalScience1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("EcologicalScience1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/");

		Helper.capturescreenshot(driver, "EcologicalScienceIN_Test");
