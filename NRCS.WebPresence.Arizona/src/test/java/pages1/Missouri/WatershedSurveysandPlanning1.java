...
public class WatershedSurveysandPlanning1 {

	static WebDriver driver;

	public WatershedSurveysandPlanning1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("WatershedSurveysandPlanning1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/planning/wsp");

		Helper.capturescreenshot(driver, "WatershedSurveysPlanning_Test");
