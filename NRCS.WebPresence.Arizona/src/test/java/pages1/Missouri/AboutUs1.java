...
public class AboutUs1 {
	...
	/*
	 * @FindBy(xpath=".//*[@id='overview']/h1/span/u/strong/span/img") static
	 * WebElement Image1Prod;
	 */
	...
	@FindBy(xpath = ".//*[@id='firstElement']/ul/li[3]/ul/li/a[2]")
	...
	public static void validateProd() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/about");
