...
public class HealthyForestsReserveProgram1 {

	static WebDriver driver;

	public HealthyForestsReserveProgram1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("HealthyForestsReserveProgram1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/easements/forests/");

		Helper.capturescreenshot(driver, "HealthyForestReserveProgramIN_Test");
