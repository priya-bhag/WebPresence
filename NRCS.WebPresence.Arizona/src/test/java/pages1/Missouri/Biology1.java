...
public class Biology1 {
	...
	public Biology1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Biology1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/bio/");

		Helper.capturescreenshot(driver, "BiologyIN_Test");
