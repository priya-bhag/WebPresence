...
public class Water1 {
	...
	public static void validateURL() {
		...
		log.info("No of main menu elements in Prod are " + LeftMainArrayProd.size());
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/water/");
		...
		try {
			...
			if (value1 = true) {
				...
				log.info("MAIN menu on  both Env: are same");
			}
		} catch (Exception e) {
