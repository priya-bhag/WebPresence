...
public class WatershedProtectionandFloodPreventionProgram1 {

	static WebDriver driver;

	public WatershedProtectionandFloodPreventionProgram1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL1() {
		...
		Logger log = Logger.getLogger("WatershedProtectionandFloodPreventionProgram1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/planning/wpfp/");

		Helper.capturescreenshot(driver, "WatershedProtectionandFloodPreventionProgram1_Test");
