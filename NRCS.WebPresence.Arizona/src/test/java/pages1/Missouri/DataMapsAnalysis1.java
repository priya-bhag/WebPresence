...
public class DataMapsAnalysis1 {

	static WebDriver driver;

	public DataMapsAnalysis1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("DataMapsAnalysis1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/dma/");

		Helper.capturescreenshot(driver, "DataMapAnalysisIN_Test");
