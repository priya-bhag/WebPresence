...
public class PhotosandVideos1 {

	static WebDriver driver;

	public PhotosandVideos1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("PhotosandVideos1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/newsroom/photos/");

		Helper.capturescreenshot(driver, "PhotosVideos_Test");
