...
public class TechnicalServiceProviders1 {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("TechnicalServiceProviders1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/cp/tsp/");

		Helper.capturescreenshot(driver, "TechnicalServiceProvidersIN_Test");
