...
public class SmallLimitedandBeginningFarmersRanchers1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/about/outreach/slbfr/");

		Helper.capturescreenshot(driver, "SmallLimitedAndBeginningFarmersRanchersIN_Test");
