...
public class WaterResources1 {
	static WebDriver driver;

	public WaterResources1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("WaterResources1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/water/resources/");

		Helper.capturescreenshot(driver, "WaterResources1_Test");
