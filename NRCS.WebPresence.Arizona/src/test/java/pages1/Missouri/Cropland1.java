...
public class Cropland1 {
	...
	/*
	 * @FindBy(xpath=".//*[@id='overview']/div[2]/p[19]/img") static WebElement
	 * Image2Prod;
	 */
	...
	/*
	 * @FindBy(xpath=
	 * ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/p[19]/img")
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/landuse/cropland/");

		Helper.capturescreenshot(driver, "CroplandIN_Test");
		...
		/*
		 * Boolean value5
		 * =Arrays.equals(Image2ArrayProd.toArray(),Image2ArrayTest.toArray());
		 * 
		 * 
		 * try{
		 * 
