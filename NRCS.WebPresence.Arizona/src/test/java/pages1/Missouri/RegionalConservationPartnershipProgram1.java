...
public class RegionalConservationPartnershipProgram1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/farmbill/rcpp/");

		Helper.capturescreenshot(driver, "RegionalConservationPartnershipProgramIN_Test");
