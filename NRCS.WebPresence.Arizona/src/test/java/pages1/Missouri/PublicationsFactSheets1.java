...
public class PublicationsFactSheets1 {
	static WebDriver driver;

	public PublicationsFactSheets1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("PublicationsFactSheets1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/newsroom/factsheets/");

		Helper.capturescreenshot(driver, "PublicationsFactSheetsTest");
