...
public class PestManagement1 {

	static WebDriver driver;

	public PestManagement1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("PestManagement1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/technical/ecoscience/pest/");

		Helper.capturescreenshot(driver, "NRCSEmployeesIN_Test");
