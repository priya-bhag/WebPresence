...
public class LandscapePlanning1 {

	static WebDriver driver;

	public LandscapePlanning1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("LandscapePlanning1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/planning/");

		Helper.capturescreenshot(driver, "LandscapePlanningIN_Test");
