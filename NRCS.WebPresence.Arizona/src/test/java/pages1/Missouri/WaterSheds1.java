...
public class WaterSheds1 {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("WaterSheds1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/water/watersheds/");

		Helper.capturescreenshot(driver, "WaterSheds_Test");
