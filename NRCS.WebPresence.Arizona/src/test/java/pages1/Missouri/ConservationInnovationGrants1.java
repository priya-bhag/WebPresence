...
public class ConservationInnovationGrants1 {
	...
	public static void validateProd() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/financial/cig/");

		Helper.capturescreenshot(driver, "ConservationInnovationGrantsIN_Test");
