...
public class EmergencyWatershedProtectionProgram1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mo/programs/financial/ewp/");

		Helper.capturescreenshot(driver, "EmergencyWatershedProtectionProgramIN_Test");
