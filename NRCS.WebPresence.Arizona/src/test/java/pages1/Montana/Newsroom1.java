...
public class Newsroom1 {
	...
	public static void validateURL() {
		...
		for (int i = 0; i <= (Table_MainelementsProd_elements).size() - 1; i++) {
		...
		/*
		 * log.info("The Left menu items are of Prod is "
		 * +Table_MainelementsArrayProd );
		 * 
		 * 
		 * log.info("Number of Left menu items in Prod is "
		 * +Table_MainelementsArrayProd.size() );
		 * 
		 */
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/newsroom/#");

		Helper.capturescreenshot(driver, "NewsRoomIN_Test");
		...
		for (int i = 0; i <= (Table_MainelementsTest_elements).size() - 1; i++) {
		...
		/*
		 * log.info("The Left menu items are of Test is "
		 * +Table_MainelementsArrayTest );
		 * 
		 * 
		 * log.info("Number of Left menu items in Test is "
		 * +Table_MainelementsArrayTest.size() );
		 * 
		 * 
		 */
