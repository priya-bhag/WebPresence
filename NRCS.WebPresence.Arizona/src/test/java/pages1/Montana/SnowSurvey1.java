...
public class SnowSurvey1 {
	...
	public static void validateProd() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/snow/");
		 ...
		 * 
		 * 
		 * if(value==false){ log.info("image1 of both Env: are not same");
		 * 
		 * }
		 * 
		 * } catch(Exception e){
		 ...
		 * 
		 * 
		 * if(a==false){ log.info("image3 of both Env: are not same");
		 * 
		 * }
		 * 
		 * } catch(Exception e){
