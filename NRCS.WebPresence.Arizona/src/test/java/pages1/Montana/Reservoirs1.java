...
public class Reservoirs1 {

	static WebDriver driver;

	public Reservoirs1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Reservoirs1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/snow/waterproducts/reservoirs/");

		Helper.capturescreenshot(driver, "ReservoirsAZ_Test");
