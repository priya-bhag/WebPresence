...
public class BasinOutlookReports1 {

	static WebDriver driver;

	public BasinOutlookReports1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	 ...
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[1]") static WebElement
	 * content1Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[1]") static WebElement
	 * content2Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[1]") static WebElement
	 * content3Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[2]") static WebElement
	 * content4Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[4]") static WebElement
	 * content5Prod;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[6]") static WebElement
	 * content6Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[2]") static WebElement
	 * content7Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[2]") static WebElement
	 * content8Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table8']") static WebElement content9Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[3]") static WebElement
	 * content10Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[3]") static WebElement
	 * content11Prod;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table7']") static WebElement content12Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[4]") static WebElement
	 * content13Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[4]") static WebElement
	 * content14Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table6']") static WebElement content15Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[6]") static WebElement
	 * content16Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[6]") static WebElement
	 * content17Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='table5']") static WebElement content18Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[7]") static WebElement
	 * content19Prod;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[7]") static WebElement
	 * content20Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table4']") static WebElement content21Prod;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[8]") static WebElement
	 * content22Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[9]") static WebElement
	 * content23Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table3']") static WebElement content24Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[9]") static WebElement
	 * content25Prod;
	 * 
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/p[11]") static WebElement
	 * content26Prod;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='table2']") static WebElement content27Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[11]") static WebElement
	 * content28Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/table[9]") static WebElement
	 * content29Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/h3[12]") static WebElement
	 * content30Prod;
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[2]/p[19]") static WebElement
	 * content31Prod;
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='overview']/div[2]/p[20]") static WebElement
	 * content32Prod;
	 */
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("BasinOutlookReports1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/snow/waterproducts/basin/#");

		Helper.capturescreenshot(driver, "BasinOutlookReportsAZ_Test");
