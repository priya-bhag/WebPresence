...
public class SiteMetadataInformation1 {

	static WebDriver driver;

	public SiteMetadataInformation1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("SiteMetadataInformation1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/snow/products/info/");

		Helper.capturescreenshot(driver, "SiteMetadataInformationAZ_Test");
