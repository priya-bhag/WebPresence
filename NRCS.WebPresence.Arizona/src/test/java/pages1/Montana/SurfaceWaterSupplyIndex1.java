...
public class SurfaceWaterSupplyIndex1 {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("SurfaceWaterSupplyIndex1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/snow/waterproducts/surface/");

		Helper.capturescreenshot(driver, "SurfaceWaterSupplyIndexAZ_Test");
