...
public class ContactUs1 {
	...
	public static void validateProd() {
		 ...
		 * 
		 * log.info("No of links inside Related links in Prod are  "
		 * +LeftTable2ArrayProd.size());
		 * 
		 * 
		 * log.info("\t");
		 */
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/contact/");
		 ...
		 * 
		 * log.info("No of links inside Related links in Test are  "
		 * +LeftTable2ArrayTest.size());
		 * 
		 * 
		 * log.info("\t");
		 * 
