...
public class Energy1 {
	...
	static Logger log = Logger.getLogger("Energy1");

	static WebDriver driver;

	public Energy1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	static List<WebElement> Table_HeaderProd;
	 ...
	 * static WebElement TableLinkProd;
	 */
	...
	static List<WebElement> Table_HeaderTest;

	/*
	 * @FindBy(xpath=".//div[@class='box']/ul/li/a") static WebElement
	 * TableLinkTest;
	 */
	...
	public static void validateURL() {
		...
		List<WebElement> Left_MainMenuElementProd = Table_HeaderProd;
		...
		/*
		 * log.info("Left header  in Prod are ");
		 * 
		 * 
		 * log.info(LeftMainArrayProd);
		 * 
		 * //log.info("No of main menu elements in Prod are "+LeftMainArrayProd.
		 * size());
		 * 
		 * 
		 * log.info("\t");
		 * 
		 * 
		 * log.info("checking link under Related Links in Prod ");
		 */
		/*
		 * String url3=TableLinkProd.getAttribute("href");
		 * 
		 * 
		 * if(TableLinkProd.getAttribute("href") != null){
		 * 
		 ...
		 */
		/*
		 * log.info("link is verified in Prod ");
		 */
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "mt/energy/#");

		Helper.capturescreenshot(driver, "EnergyIN_Test");
		...
		List<WebElement> Left_MainMenuElementTest = Table_HeaderTest;
		...
		/*
		 * log.info("Left page Header in Test is");
		 * 
		 * 
		 * log.info(LeftMainArrayTest);
		 * 
		 * //log.info("No of main menu elements in Test are "+LeftMainArrayTest.
		 * size());
		 * 
		 * 
		 * log.info("\t");
		 * 
		 * log.info("checking link under Related Links in Test ");
		 *//*
			 * String url4=TableLinkTest.getAttribute("href");
			 * 
			 * 
			 * 
			 * if(TableLinkTest.getAttribute("href") != null){
			 * 
			 * 
		...
		// log.info("verified link in table2 Test");
