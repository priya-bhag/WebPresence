...
public class Programs1 {
	...
	/*
	 * @FindBy(xpath=".//*[@id='selectedTree']/ul/li/a[2]") static
	 * List<WebElement> Table_MainelementsProd;
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='selectedTree']/ul/li/ul/li/a[2]") static
	 * List<WebElement> Table_SubElementsProd;
	 * 
	 * 
	 * 
	 * 
	 ...
	 * 
	 * @FindBy(xpath=
	 * ".//*[@id='mainContent']/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td[1]/table/tbody/tr[4]/td/table/tbody/tr/td/div/p")
	 ...
	 * 
	 * @FindBy(xpath=
	 * ".//*[@id='mainContent']/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td[1]/table/tbody/tr[4]/td/table/tbody/tr/td/div/ul/li/a")
	 * static WebElement Table2_SubElementlINKSProd;
	 * 
	 * @FindBy(xpath=".//*[@id='promobox']/div") static WebElement Table3Prod;
	 * 
	 * 
	 * 
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='PromoNRCSEPRD420928']") static WebElement
	 * Table3HeaderProd;
	 * 
	 * 
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='promobox']/div/p/a") static WebElement
	 * Table3_LinkProd;
	 */
	...
	/*
	 * @FindBy(xpath=".//*[@id='tree']/li/ul/li/a[2]") static List<WebElement>
	 * Table_MainelementsTest;
	 * 
	 * 
	 ...
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='promobox']/div") static WebElement Table3Test;
	 * 
	 * 
	 * 
	 * 
	 ...
	 * 
	 * 
	 * @FindBy(xpath=".//*[@id='firstElement']/ul/li/ul/li/a[2]") static
	 * List<WebElement> Table_SubElementsTest;
	 * 
	 */
	...
	public static void ValidateProd() {
		 ...
		 * log.info("\t");
		 * 
		 * button1Prod.click(); button2Prod.click(); button3Prod.click();
		 * button4Prod.click(); button5Prod.click();
		 * 
		 * 
		 ...
		 * 
		 * log.info("CIG Menu is present on the left Menu :Prod"); }else{
		 * 
		 ...
		 * } else{ log.
		 * info("Areas Of Focus is not present on the let side of page : Prod");
		 * 
		 * }
		 * 
		 * 
		 ...
		 * 
		 * log.
		 * info("Agricultural Conservation Easement Program (ACEP), Conservation Reserve Program (CRP) is present under Areas Of Focus"
		 * ); } else{
		 * 
		 * log.
		 * info(" Agricultural Conservation Easement Program (ACEP) ,Conservation Reserve Program (CRP)is not present under Areas Of Focus"
		 * ); } log.info("\t");
		 * 
		 * 
		 ...
		 * 
		 * log.
		 * info("Ad for System for Award Management (Sam.gov) is present : Prod "
		 * ); } else{ log.
		 * info("Ad for System for Award Management (Sam.gov)  is Not present :Prod "
		 * );
		 * 
		 * }
		 * 
		 ...
		 * 
		 * log.
		 * info("This DUNS SAMS Fact Sheet provides important info for entities appying for conservation programs : image is present : Prod "
		 * ); } else{ log.
		 * info("This DUNS SAMS Fact Sheet provides important info for entities appying for conservation programs : image is Not present :Prod "
		 * );
		 * 
		 * }
		 * 
		 ...
		 * 
		 * log.
		 * info("Link is present :How to Obtain a DUNS Number And Register on SAM.gov:= under image :Prod "
		 * ); }else{ log.
		 * info("Link is Not present :How to Obtain a DUNS Number And Register on SAM.gov= under image :Prod "
		 * );
		 * 
		 * }
		 * 
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "ia/programs/");
		 ...
		 * log.info("\t");
		 * 
		 * button1Test.click(); button2Test.click(); button3Test.click();
		 * button4Test.click(); button5Test.click();
		 * 
		 * 
		 ...
		 * 
		 * log.info("CIG Menu is present on the left Menu :Test"); }else{
		 * 
		 ...
		 * 
		 * List<WebElement>
		 * BreadCrumbTest_elements=BreadCrumbTest.findElements(By.tagName("p"));
		 * 
		 * 
		 * 
		 ...
		 * 
		 * Boolean value
		 * =Arrays.equals(LeftMainArrayProd.toArray(),LeftMainArrayTest.toArray(
		 * ));
		 * 
		 * try{ if (value=true){
		 * 
		 ...
		 * 
		 * Boolean value1=
		 * Arrays.equals(LeftSubMenuArrayProd.toArray(),LeftSubMenuArrayProd.
		 * toArray());
		 * 
		 * 
		 * if (value1=true){
		 ...
		 * 
		 * Boolean value2
		 * =Arrays.equals(BreadCrumbArrayTest.toArray(),BreadCrumbArrayProd.
		 * toArray());
		 * 
		 * 
		 * if (value2=true){
		 * 
		 * log.info("BreadCrumb on both Env: are same"); } else{
		 * 
		 * log.info("Breadcrumb on both Env: are not same"); } } catch(Exception
		 * e){ e.toString(); }
		 */
		try {
			if (count == count1) {
		 ...
		 * 
		 * 
		 * log.info("\t"); Boolean Table2_Header_PresentTest =
		 * Table2_HeadingTest.isDisplayed();
		 * 
		 * 
		 * 
		 * if(Table2_Header_PresentTest){
		 * 
		 * log.info("Soils is present on the let side of page : Test"); } else{
		 ...
		 * if(Table2_sub_present){
		 * 
		 * log.info("Soil Health is present under Soils"); } else{
		 * 
		 * log.info("Soil Health is not present under Soils"); } log.info("\t");
		 * 
		 * 
		 ...
		 * 
		 * log.
		 * info("This DUNS SAMS Fact Sheet provides important info for entities appying for conservation programs : image is present : Test "
		 * ); } else{ log.
		 * info("This DUNS SAMS Fact Sheet provides important info for entities appying for conservation programs : image is Not present :Test "
		 * );
		 * 
		 * }
		 * 
		 ...
		 * 
		 * log.
		 * info("Link is present : Obtaining a Data Universal Numbering System (DUNS) Number:= under image :Test "
		 * ); }else{ log.
		 * info("Link is Not present : Obtaining a Data Universal Numbering System (DUNS) Number:= under image :Test "
		 * );
		 * 
		 * }
		 * 
