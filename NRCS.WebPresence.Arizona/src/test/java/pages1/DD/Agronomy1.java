...
public class Agronomy1 {
	...
	/*
	 * @FindBy(xpath =
	 * ".//*[@id='mainContent']/table/tbody/tr/td/table/tbody/tr[3]/td/table/tbody/tr/td[1]/table/tbody")
	...
	/*
	 * @FindBy(xpath = "//div[@class='left']") static WebElement LeftNavTest;
	 */
	...
	public static void validateURL() throws IOException, InterruptedException {
		...
		driver.get(
				DataProviderFactory.getConfig().getApplicationUrl3() + DataProviderFactory.getExcel().getdata(0, 2, 1));
