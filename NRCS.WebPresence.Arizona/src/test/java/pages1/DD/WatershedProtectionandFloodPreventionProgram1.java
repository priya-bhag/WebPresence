...
public class WatershedProtectionandFloodPreventionProgram1 {
	...
	public static void validateURL1() throws IOException, InterruptedException {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3()
				+ DataProviderFactory.getExcel().getdata(0, 84, 1));

		Helper.capturescreenshot(driver, "StateOfficeIN_Test");
