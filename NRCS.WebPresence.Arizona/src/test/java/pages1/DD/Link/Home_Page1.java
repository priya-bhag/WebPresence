...
public class Home_Page1 {
	...
	@FindBy(xpath = ".//*[@id='level1_hitarea_108000000000000']")
	static WebElement button2Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1011000000000000']")
	static WebElement button3Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1014000000000000']")
	static WebElement button4Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1017000000000000']")
	static WebElement button5Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1019000000000000']")
	static WebElement button6Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1020000000000000']")
	static WebElement button7Test;

	@FindBy(xpath = ".//*[@id='level1_hitarea_1021000000000000']")
	...
	public static void MenuElementsProd() throws IOException {
		...
		for (int i = 0; i <= Topics_MainMenuElementProd.size() - 1; i++) {
		...
		for (int i = 0; i <= Topics_SubMenuElementProd.size() - 1; i++) {
		...
		for (int i = 0; i <= Programs_ElementsProd.size() - 1; i++) {
		...
		for (int i = 0; i <= NewsRoom_ElementsProd.size() - 1; i++) {
		...
		for (int i = 0; i <= ContactUS_ElementsProd.size() - 1; i++) {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3()
				+ DataProviderFactory.getExcel().getdata(0, 36, 1));

		Helper.capturescreenshot(driver, "HomePageIN_Test");
		...
		for (int i = 0; i <= Topics_MainMenuElementTest.size() - 1; i++) {
		...
		for (int i = 0; i <= Topics_SubMenuElementTest.size() - 1; i++) {
		...
		for (int i = 0; i <= Programs_ElementsTest.size() - 1; i++) {
		...
		for (int i = 0; i <= NewsRoom_ElementsTest.size() - 1; i++) {
		...
		for (int i = 0; i <= ContactUS_ElementsTest.size() - 1; i++) {
