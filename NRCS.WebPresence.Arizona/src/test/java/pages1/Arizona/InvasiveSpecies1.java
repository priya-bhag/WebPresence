...
public class InvasiveSpecies1 {

	static WebDriver driver;

	public InvasiveSpecies1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("InvasiveSpecies1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/ecoscience/invasive/");

		Helper.capturescreenshot(driver, "InasiveSpeciesAZ_Test");
