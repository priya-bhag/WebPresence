...
public class AirQuality1 {
	...
	static Logger log = Logger.getLogger("AirQuality1");

	static WebDriver driver;

	public AirQuality1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='table1']/tbody/tr/td/p[1]/b/img")
	static WebElement Image2Prod;

	@FindBy(xpath = ".//*[@id='table1']/tbody/tr/td/p[2]/img")

	static WebElement Image3Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[4]/img[1]")

	static WebElement Image4Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[4]/img[2]")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[5]/img[1]")

	static WebElement Image4Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[5]/img[2]")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("AirQuality1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/air/quality");

		Helper.capturescreenshot(driver, "AirQualityAZ_Test");
		...
		try {
			...
			if (c == false) {
				log.info("image5 of both urls are not same");
