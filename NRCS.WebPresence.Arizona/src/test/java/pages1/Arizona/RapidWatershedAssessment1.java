...
public class RapidWatershedAssessment1 {
	...
	public RapidWatershedAssessment1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("RapidWatershedAssessment1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/dma/rwa/");

		Helper.capturescreenshot(driver, "RapidWaterShedAssessmentAZ_Test");
