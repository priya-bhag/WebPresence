...
public class NationalResourcesInventory1 {
	...
	public NationalResourcesInventory1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("NationalResourcesInventory1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/dma/nri/");

		Helper.capturescreenshot(driver, "NationalResourcesInvetoryAZ_Test");
