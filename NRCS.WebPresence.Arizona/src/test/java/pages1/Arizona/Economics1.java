...
public class Economics1 {
	...
	public Economics1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Economics1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/dma/econ/");

		Helper.capturescreenshot(driver, "EconomicsAZ_Test");
