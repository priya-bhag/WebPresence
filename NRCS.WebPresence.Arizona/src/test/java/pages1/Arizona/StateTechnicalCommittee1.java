...
public class StateTechnicalCommittee1 {

	static Logger log = Logger.getLogger("StateTechnicalCommittee1");

	static WebDriver driver;

	public StateTechnicalCommittee1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/stc/");

		Helper.capturescreenshot(driver, "StateTechnicalCommitteeAZ_Test");
