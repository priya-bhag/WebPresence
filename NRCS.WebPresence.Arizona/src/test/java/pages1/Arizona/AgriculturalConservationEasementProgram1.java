...
public class AgriculturalConservationEasementProgram1 {
	...
	static Logger log = Logger.getLogger("AgriculturalConservationEasementProgram1");
	...
	@FindBy(xpath = ".//*[@id='overview']/div[2]/p[19]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/p[19]/img")
	...
	public static void validateURL() {
		 ...
		 * 
		 * log.info("The page source is "+htmlSource);
		 */
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/easements/acep/");

		Helper.capturescreenshot(driver, "AgriculturalConservationEasementProgramAZ_Test");
		...
		if (heading1.equals(heading2)) {
			...
			log.info("Heading of both Env: are not same");
