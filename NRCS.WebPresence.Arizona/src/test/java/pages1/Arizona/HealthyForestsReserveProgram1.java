...
public class HealthyForestsReserveProgram1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/easements/forests/");

		Helper.capturescreenshot(driver, "HealthyForestsReserveProgramAZ_Test");
