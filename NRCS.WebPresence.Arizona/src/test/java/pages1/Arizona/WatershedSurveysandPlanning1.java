...
public class WatershedSurveysandPlanning1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/planning/wsp/");

		Helper.capturescreenshot(driver, "WaterShedSurveysandPlanningAZ_Test");
