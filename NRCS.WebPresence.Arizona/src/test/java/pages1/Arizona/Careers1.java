...
public class Careers1 {
	static WebDriver driver;

	public Careers1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Careers1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about/careers/");

		Helper.capturescreenshot(driver, "CareersAZ_Test");
