...
public class GIS1 {
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("GIS1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/dma/gis/");

		Helper.capturescreenshot(driver, "GISAZ_Test");
