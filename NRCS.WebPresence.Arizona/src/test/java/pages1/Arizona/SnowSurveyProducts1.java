...
public class SnowSurveyProducts1 {

	static WebDriver driver;

	public SnowSurveyProducts1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("SnowSurveyProducts1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/snow/products/");

		Helper.capturescreenshot(driver, "SnowSurveyProductsAZ_Test");
