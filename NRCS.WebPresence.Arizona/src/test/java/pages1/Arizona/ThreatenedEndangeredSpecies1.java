...
public class ThreatenedEndangeredSpecies1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/ecoscience/threat/");

		Helper.capturescreenshot(driver, "ThreatenedEndangeresSpeciesAZ_Test");
