...
public class Engineering1 {

	static WebDriver driver;

	public Engineering1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Engineering1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/engineering/");
		Helper.capturescreenshot(driver, "EngineeringAZ_Test");
