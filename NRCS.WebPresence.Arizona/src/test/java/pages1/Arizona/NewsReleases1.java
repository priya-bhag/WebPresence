...
public class NewsReleases1 {

	static WebDriver driver;

	public NewsReleases1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements

	@FindBy(xpath = ".//*[@id='newstitle']/h2")
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("NewsReleases1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/newsroom/releases/");

		Helper.capturescreenshot(driver, "NewsReleasesAZ_Test");
