...
public class Energy1 {
	...
	@FindBy(xpath = ".//*[@id='overview']/h3/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h3/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Energy1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/energy/#");

		Helper.capturescreenshot(driver, "EnergyAZ_Test");
...
*/
		...
		Boolean value7 = Arrays.equals(ImageArray1Prod.toArray(), ImageArray1Test.toArray());
