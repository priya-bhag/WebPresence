...
public class DataAnalysis1 {
	...
	public DataAnalysis1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("DataAnalysis1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/snow/products/data/");

		Helper.capturescreenshot(driver, "DataAnalysisAZ_Test");
