...
public class StateOffice1 {

	static WebDriver driver;

	public StateOffice1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// URL1 Elements
	...
	public static void validateURL1() {
		...
		Logger log = Logger.getLogger("StateOffice1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/contact/state/");

		Helper.capturescreenshot(driver, "StateOfficeAZ_Test");
