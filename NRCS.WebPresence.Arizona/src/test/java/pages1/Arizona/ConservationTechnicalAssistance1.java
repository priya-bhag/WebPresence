...
public class ConservationTechnicalAssistance1 {

	static WebDriver driver;

	public ConservationTechnicalAssistance1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("ConservationTechnicalAssistance1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/cp/cta/");

		Helper.capturescreenshot(driver, "ConservationTechnicalAssistanceAZ_Test");
