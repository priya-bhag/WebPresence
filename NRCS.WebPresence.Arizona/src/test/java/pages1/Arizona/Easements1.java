...
public class Easements1 {

	static Logger log = Logger.getLogger("Easements1");

	static WebDriver driver;

	public Easements1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[2]/td[1]/p/a/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[2]/td[1]/p/a/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Easements1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/easements/#");

		Helper.capturescreenshot(driver, "EasementsAZ_Test");
