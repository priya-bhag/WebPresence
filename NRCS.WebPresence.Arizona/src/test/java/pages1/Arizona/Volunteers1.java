...
public class Volunteers1 {
	...
	static Logger log = Logger.getLogger("Volunteers1");

	static WebDriver driver;

	public Volunteers1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Volunteers1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/people/volunteers/");

		Helper.capturescreenshot(driver, "VolunteersAZ_Test");
