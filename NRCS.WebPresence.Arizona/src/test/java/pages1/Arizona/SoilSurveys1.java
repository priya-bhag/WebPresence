...
public class SoilSurveys1 {

	static WebDriver driver;

	public SoilSurveys1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h2")
	...
	public static void validate() {
		...
		Logger log = Logger.getLogger("SoilSurveys1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/soils/surveys/");

		Helper.capturescreenshot(driver, "SoilSurveysAZ_Test");
