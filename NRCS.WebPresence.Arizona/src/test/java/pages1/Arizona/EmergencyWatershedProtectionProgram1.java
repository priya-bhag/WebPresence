...
public class EmergencyWatershedProtectionProgram1 {

	static Logger log = Logger.getLogger("EmergencyWatershedProtectionProgram1");

	static WebDriver driver;

	public EmergencyWatershedProtectionProgram1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/p[1]/img")
	static WebElement Image1Prod;

	@FindBy(xpath = ".//*[@id='overview']/ul[2]/li[2]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[2]/img")
	static WebElement Image1Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/ul[2]/li[2]/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("EmergencyWatershedProtectionProgram1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/ewp/");

		Helper.capturescreenshot(driver, "EmergencyWatershedProtectionProgramAZ_Test");
