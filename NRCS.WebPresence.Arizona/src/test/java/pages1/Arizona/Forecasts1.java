...
public class Forecasts1 {

	static WebDriver driver;

	public Forecasts1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Forecasts1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/snow/waterproducts/forecasts/");

		Helper.capturescreenshot(driver, "ForeCastsAZ_Test");
