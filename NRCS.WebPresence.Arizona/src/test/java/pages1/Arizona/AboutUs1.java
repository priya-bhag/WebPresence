...
public class AboutUs1 {
	...
	public static void validateProd() {
		...
		// LeftSubMenuArrayProd.add(text1_subMenu);
		// }
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about");

		Helper.capturescreenshot(driver, "AboutUsAZ_Test");
		...
		// LeftSubMenuArrayTest.add(text1_subMenu);
		// }
