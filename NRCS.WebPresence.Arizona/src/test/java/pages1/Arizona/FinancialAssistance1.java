...
public class FinancialAssistance1 {

	static Logger log = Logger.getLogger("FinancialAssistance1");
	static WebDriver driver;

	public FinancialAssistance1(WebDriver Idriver) {
	...
	@FindBy(xpath = ".//*[@id='overview']/div[1]/img")
	static WebElement Image1Prod;

	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[1]/td[1]/a/img")
	static WebElement Image2Prod;

	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[2]/td[1]/a/img")
	static WebElement Image3Prod;

	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[3]/td[1]/a/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[1]/img")
	static WebElement Image1Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[1]/a/img")
	static WebElement Image2Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[2]/td[1]/a/img")
	static WebElement Image3Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[3]/td[1]/a/img")
	...
	public static List<Object> Image3ArrayProd = null;

	public static List<Object> Image3ArrayTest = null;

	public static List<Object> Image4ArrayProd = null;

	public static List<Object> Image4ArrayTest = null;

	public static void validateURL() {

		Logger log = Logger.getLogger("FinancialAssistance1");
		...
		Image1ArrayProd = image_check(Image1Prod);

		Image2ArrayProd = image_check(Image2Prod);

		Image3ArrayProd = image_check(Image3Prod);

		Image4ArrayProd = image_check(Image4Prod);

		// Test Methods

		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/");

		Helper.capturescreenshot(driver, "FinancialAssistanceAZ_Test");
		...
		Image1ArrayTest = image_check(Image1Test);

		Image2ArrayTest = image_check(Image2Test);

		Image3ArrayTest = image_check(Image3Test);

		Image4ArrayTest = image_check(Image4Test);

		Boolean value = Arrays.equals(Image1ArrayProd.toArray(), Image1ArrayTest.toArray());
		...
		Boolean value5 = Arrays.equals(Image2ArrayProd.toArray(), Image2ArrayTest.toArray());
		...
		Boolean va5 = Arrays.equals(Image3ArrayProd.toArray(), Image3ArrayTest.toArray());
		...
		try {
			...
			if (value5 == false) {
				log.info("image3 of both urls are not same");
		...
		Boolean valu5 = Arrays.equals(Image4ArrayProd.toArray(), Image4ArrayTest.toArray());
		...
		try {
			...
			if (value5 == false) {
				log.info("image4  of both urls are not same");
