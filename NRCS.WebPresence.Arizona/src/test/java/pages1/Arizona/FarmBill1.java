...
public class FarmBill1 {

	static Logger log = Logger.getLogger("FarmBill1");

	static WebDriver driver;

	public FarmBill1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[1]/td[2]/a/img")
	static WebElement Image3Prod;

	@FindBy(xpath = ".//*[@id='overview']/div[2]/table/tbody/tr[1]/td[3]/a/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[2]/a/img")
	static WebElement Image3Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div[2]/table/tbody/tr[1]/td[3]/a/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("FarmBill1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/farmbill/");
		Helper.capturescreenshot(driver, "FarmBillAZ_Test");
