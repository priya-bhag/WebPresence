...
public class ConservationInnovationGrants1 {

	static WebDriver driver;

	public ConservationInnovationGrants1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("ConservationInnovationGrants1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/cig/");

		Helper.capturescreenshot(driver, "ConservationInnovationGrantsAZ_Test");
