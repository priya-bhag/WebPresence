...
public class SoilHealth1 {

	static Logger log = Logger.getLogger("SoilHealth1");

	static WebDriver driver;

	public SoilHealth1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/p[4]/a/img")
	static WebElement Image1Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[11]/a/img")
	static WebElement Image2Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[14]/a/img")

	static WebElement Image3Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[16]/img[1]")

	static WebElement Image4Prod;

	@FindBy(xpath = ".//*[@id='overview']/p[17]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h2[1]/a")
	static WebElement headingTest;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[5]/a/img")
	static WebElement Image1Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[12]/a/img")
	static WebElement Image2Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[15]/a/img")

	static WebElement Image3Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[17]/img")

	static WebElement Image4Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[18]/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("SoilHealth1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/soils/health/");

		Helper.capturescreenshot(driver, "SoilHealthAZ_Test");
		...
		/*
		 * Boolean value2
		 * =Arrays.equals(YouAreHereArrayTest.toArray(),YouAreHereArrayProd.
		 * toArray());
		 * 
		 * 
		 * try{
		 ...
		 * 
		 * 
		 * if(value2==false){ log.info("Breadcrumb of both Env: are not same");
		 * 
		 * }
		 * 
		 * } catch(Exception e){
		...
		Boolean va = Arrays.equals(BreadCrumbArrayTest.toArray(), BreadCrumbArrayProd.toArray());
