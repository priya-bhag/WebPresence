...
public class WaterSupply1 {

	static WebDriver driver;

	public WaterSupply1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// URL1 Elements
	...
	public static void validate() {
		...
		Logger log = Logger.getLogger("WaterSupply1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/snow/waterproducts/supply/");

		Helper.capturescreenshot(driver, "WaterSupplyAZ_Test");
