...
public class ConservationCompliance1 {
	...
	static Logger log = Logger.getLogger("ConservationCompliance1");
	...
	@FindBy(xpath = ".//*[@id='overview']/h4[1]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h4[1]/img")
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/farmbill/cc/");

		Helper.capturescreenshot(driver, "ConservationComplianceAZ_Test");
