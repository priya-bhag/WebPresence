...
public class STCAgenda1 {
	static WebDriver driver;

	public STCAgenda1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("STCAgenda1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/stc/agenda/");

		Helper.capturescreenshot(driver, "STCAgendaAZ_Test");
