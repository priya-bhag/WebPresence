...
public class ManureManagement1 {

	static WebDriver driver;

	public ManureManagement1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("ManureManagement1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/ecoscience/manure/");

		Helper.capturescreenshot(driver, "ManureManagementAZ_Test");
		...
		try {
			...
			if (value2 == true) {
				...
				log.info("Breadcrumb of b both Env: are same");
			}
