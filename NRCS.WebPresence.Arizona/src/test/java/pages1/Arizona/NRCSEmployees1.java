...
public class NRCSEmployees1 {

	static WebDriver driver;

	public NRCSEmployees1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("NRCSEmployees1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/people/employees/");

		Helper.capturescreenshot(driver, "NRCSEmployeesAZ_Test");
