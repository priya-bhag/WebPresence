...
public class OutreachAdvocacy1 {

	static WebDriver driver;

	static Logger log = Logger.getLogger("OutreachAdvocacy1");

	public OutreachAdvocacy1(WebDriver Idriver) {
	...
	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr/td[2]/p[21]/span/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr/td[2]/p[21]/span/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("OutreachAdvocacy1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about/outreach/");

		Helper.capturescreenshot(driver, "OutReachAdvocacyAZ_Test");
