...
public class Features1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/newsroom/features/");

		Helper.capturescreenshot(driver, "FeaturesAZ_Test");
		...
		try {
			...
			if (value2 == true) {
				...
				log.info("Breadcrumb of  on both Env: are same");
			}
