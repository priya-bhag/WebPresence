...
public class WaterSupplyProducts1 {

	static WebDriver driver;

	public WaterSupplyProducts1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("WaterSupplyProducts1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/snow/waterproducts/");

		Helper.capturescreenshot(driver, "WaterSupplyProductsAZ_Test");
		 ...
		 * log.info("The contents in both URLs are same"); } else{
		 * log.info("The contents in both URLs are not same"); } log.info("\t");
		 */
