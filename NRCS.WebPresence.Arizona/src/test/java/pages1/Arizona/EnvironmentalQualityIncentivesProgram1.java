...
public class EnvironmentalQualityIncentivesProgram1 {

	static Logger log = Logger.getLogger("EnvironmentalQualityIncentivesProgram1");

	static WebDriver driver;

	public EnvironmentalQualityIncentivesProgram1(WebDriver Idriver) {
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/div/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("EnvironmentalQualityIncentivesProgram1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/eqip/");

		Helper.capturescreenshot(driver, "EnvironmentalQualityIncentivesProgramAZ_Test");
