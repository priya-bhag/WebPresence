...
public class LandscapeInitiatives1 {

	static Logger log = Logger.getLogger("LandscapeInitiatives1");

	static WebDriver driver;

	public LandscapeInitiatives1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr[1]/td/img")
	static WebElement Image1Prod;

	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr[2]/td/p[1]/em/a/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr[1]/td/img")
	static WebElement Image1Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr[2]/td/p[1]/em/a/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("LandscapeInitiatives1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/landscape/#");

		Helper.capturescreenshot(driver, "LansapeInitiativesAZ_Test");
