...
public class Partners1 {

	static WebDriver driver;

	public Partners1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("Partners1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/people/partners/");

		Helper.capturescreenshot(driver, "PartnersAZ_Test");
