...
public class WatershedProtectionandFloodPreventionProgram1 {
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/planning/wpfp/");

		Helper.capturescreenshot(driver, "WaterShedProtectionandFloodPreventionProgramAZ_Test");
