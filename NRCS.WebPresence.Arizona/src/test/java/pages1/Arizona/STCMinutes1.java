...
public class STCMinutes1 {

	static WebDriver driver;

	public STCMinutes1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	// Prod Elements
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("STCMinutes1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/stc/minutes/");

		Helper.capturescreenshot(driver, "STCMinutesmAZ_Test");
