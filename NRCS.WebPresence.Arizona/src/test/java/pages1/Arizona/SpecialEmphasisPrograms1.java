...
public class SpecialEmphasisPrograms1 {

	static WebDriver driver;

	public SpecialEmphasisPrograms1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validate() {
		...
		Logger log = Logger.getLogger("SpecialEmphasisPrograms1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about/outreach/sep//");

		Helper.capturescreenshot(driver, "SpecialEmphasisProgramsAZ_Test");
