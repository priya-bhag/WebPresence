...
public class TechnicalResources1 {
	...
	public static void validateProd() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/");

		Helper.capturescreenshot(driver, "TechnicalResourcesAZ_Test");
		...
		// 30).until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@id='firstElement']/div")));
		button1Test.click();
		button2Test.click();
		button3Test.click();
		button4Test.click();
