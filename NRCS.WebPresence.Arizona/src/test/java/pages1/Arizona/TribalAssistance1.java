...
public class TribalAssistance1 {

	static Logger log = Logger.getLogger("TribalAssistance1");

	static WebDriver driver;

	public TribalAssistance1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/p[7]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/p[8]/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("TribalAssistance1");
		...
		/*
		 * String contentProd =AzProd.getText(); String NewcontentProd
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about/outreach/tribal/");

		Helper.capturescreenshot(driver, "TribalAssistanceAZ_Test");
		 ...
		 * 
		 * 
		 * if(value5==false){ log.info("image2 of both Env: are not same");
		 * 
		 * }
		 * 
		 * } catch(Exception e){
	 ...
	 * 
	 * 
	 * // log.info("No of links with response code OK are "+count1); } catch
	 * (Exception e) {
	 * 
	 * }
	 */
