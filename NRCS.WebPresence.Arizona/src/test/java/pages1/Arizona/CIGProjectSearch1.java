...
public class CIGProjectSearch1 {
	...
	public static void validateProd() {
		...
		Logger log = Logger.getLogger("CIGProjectSearch1");
		...
		String contentProd = AZProd.getText();
		 ...
		 * SearchButton1Prod.click();
		 * 
		 * String heading_searchResult2 =
		 * driver.findElement(By.xpath(".//*[@id='cigSearch']/h2")).getText();
		 * 
		 * if(heading_searchResult2.
		 * equalsIgnoreCase("Search Results - Conservation Innovation Grants")){
		 * log.info("the search worked"); }
		 * 
		 * 
		 * 
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/cig/cigsearch");

		Helper.capturescreenshot(driver, "CIGProjectSearchAZ_Test");
