...
public class RangePasture1 {

	static Logger log = Logger.getLogger("RangePasture1");

	static WebDriver driver;

	public RangePasture1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	@FindBy(xpath = ".//*[@id='overview']/ul/li[1]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/ul/li[1]/img")
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("RangePasture1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/landuse/pasture/");

		Helper.capturescreenshot(driver, "RangePastureAZ_Test");
