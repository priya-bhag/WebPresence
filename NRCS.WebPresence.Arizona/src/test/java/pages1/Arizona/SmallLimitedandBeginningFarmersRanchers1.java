...
public class SmallLimitedandBeginningFarmersRanchers1 {
	static WebDriver driver;

	static Logger log = Logger.getLogger("SmallLimitedandBeginningFarmersRanchers1");

	public SmallLimitedandBeginningFarmersRanchers1(WebDriver Idriver) {
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("SmallLimitedandBeginningFarmersRanchers1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/about/outreach/slbfr/");

		Helper.capturescreenshot(driver, "SmallLimitedAndBeginningFarmersRanchersAZ_Test");
