...
public class Soils1 {
	...
	/*
	 * @FindBy(xpath="") static WebElement Video1Test;
	 */
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Soils1");
		...
		if (table2_present) {
			...
			log.info(
					"Related Links :  is present with links :Soil Properties - Shrink/Swell Potential : Soil Survey Region 8");
		} else {
			log.info(
					"Related Links :  is Not present with links :Soil Properties - Shrink/Swell Potential : Soil Survey Region 8");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/soils/");

		Helper.capturescreenshot(driver, "SoilsAZ_Test");
		...
		Boolean table3_present = false;

		try {
			table3_present = Table2Test.isDisplayed();
		}
		...
		if (table3_present) {
			...
			log.info(
					"Related Links :  is present with links Test :Soil Properties - Shrink/Swell Potential : Soil Survey Region 8");
		} else {
			log.info(
					"Related Links :  is Not  present with links :Soil Properties - Shrink/Swell Potential : Soil Survey Region 8");
		...
		try {
			...
			url5 = Table2Link1Test.getAttribute("href");
		} catch (Exception e) {
			e.getMessage();
		}
