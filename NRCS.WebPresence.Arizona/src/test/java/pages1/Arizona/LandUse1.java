...
public class LandUse1 {
	...
	static Logger log = Logger.getLogger("LandUse1");
	...
	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr/td[1]/img")
	static WebElement Image1Prod;

	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr/td[2]/img")
	static WebElement Image2Prod;

	@FindBy(xpath = ".//*[@id='overview']/table/tbody/tr/td[3]/img")
	...
	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr/td[1]/img")
	static WebElement Image1Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr/td[2]/img")
	static WebElement Image2Test;

	@FindBy(xpath = ".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/table/tbody/tr/td[3]/img")
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/technical/landuse/");

		Helper.capturescreenshot(driver, "LandUseAZ_Test");
		...
		/*
		 * 
		 * String contentTest=AzTest.getText();
		 * 
		...
		Boolean valu = Arrays.equals(ImageArray3Prod.toArray(), ImageArray3Test.toArray());
