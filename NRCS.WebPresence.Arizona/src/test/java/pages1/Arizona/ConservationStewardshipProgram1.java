...
public class ConservationStewardshipProgram1 {
	...
	static Logger log = Logger.getLogger("ConservationStewardshipProgram1");
	...
	public static void validateURL() {
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "az/programs/financial/csp/");

		Helper.capturescreenshot(driver, "ConservationStewardshipProgramAZ_Test");
