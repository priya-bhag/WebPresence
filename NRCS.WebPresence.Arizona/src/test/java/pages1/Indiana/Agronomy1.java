...
public class Agronomy1 {

	static WebDriver driver;

	public Agronomy1(WebDriver Idriver) {
		this.driver = Idriver;
	}
	...
	public static void validateURL() {
		...
		Logger log = Logger.getLogger("Agronomy1");
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "in/technical/ecoscience/agronomy/");

		Helper.capturescreenshot(driver, "AgronomyIN_Test");
