...
public class People1 {
	...
	public static void validateURL() {
		...
		if (table2_present) {
			...
			log.info(
					"Areas Of Focus :  is present with links : Beginning, Limited, Socially Disadvantaged and Military Veteran Farmers Landowners");
		} else {
			log.info(
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3() + "IN/people");

		Helper.capturescreenshot(driver, "PeopleTest");
