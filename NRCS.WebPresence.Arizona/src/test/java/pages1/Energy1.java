...
static WebElement TableLinkURL1;
	...
	@FindBy(xpath="")
	static WebElement TableLinkURL2;
...
System.out.println("checking link under table1");

String url3=TableLinkURL1.getAttribute("href");


if(TableLinkURL1.getAttribute("href") != null){
...
System.out.println("No of main menu elements "+LeftMainArrayURL2.size());


System.out.println("\t");

System.out.println("verify link in table2 URL2");

String url4=TableLinkURL2.getAttribute("href");



if(TableLinkURL2.getAttribute("href") != null){
...
System.out.println("verified link in table2 URL2");
...
Boolean value7 =Arrays.equals(ImageArray1URL1.toArray(),ImageArray1URL2.toArray());
