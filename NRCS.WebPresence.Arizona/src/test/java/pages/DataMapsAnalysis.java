...
public class DataMapsAnalysis {


	
	static WebDriver driver;
	
	public DataMapsAnalysis(WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
	...
	driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/technical/dma/");
