...
public class EmergencyWatershedProtectionProgram {

	
	static WebDriver driver;
	
	public EmergencyWatershedProtectionProgram(WebDriver Idriver){
		this.driver=Idriver;
	}
...
count=count+1;
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/financial/ewp/");
