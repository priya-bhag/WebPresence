...
public class Agronomy_DEV {

	
	static WebDriver driver;
	
	public Agronomy_DEV(WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl3()+"main/az/technical/ecoscience/agronomy/");
