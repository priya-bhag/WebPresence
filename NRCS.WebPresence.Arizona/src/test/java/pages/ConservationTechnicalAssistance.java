...
public class ConservationTechnicalAssistance {
	

	
	static WebDriver driver;
	
	public ConservationTechnicalAssistance(WebDriver Idriver){
		this.driver=Idriver;
	}
	...
	count=count+1;
			...
			driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/technical/cp/cta/");
...
if (content1.contentEquals(content2)){
	...
	//Assert.assertEquals(getApplicationTitle1(),driver.getTitle());
