...
public class FarmBill {
	...
	public FarmBill(WebDriver Idriver){
		this.driver=Idriver;
	}
...
count=count+1;
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/farmbill/");
...
count1=count1+1;
	  ...
	  //  image_check(Image1URL2);
		...
		Image4ArrayURL2=image_check(Image3URL2);
...
Boolean value6=Arrays.equals(Image4ArrayURL1.toArray(),Image4ArrayURL2.toArray());
