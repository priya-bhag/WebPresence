...
public class WatershedProtectionandFloodPreventionProgram {

	static WebDriver driver;
	
	public WatershedProtectionandFloodPreventionProgram(WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/planning/wpfp/");
