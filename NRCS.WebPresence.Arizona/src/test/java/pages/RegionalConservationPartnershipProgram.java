...
public class RegionalConservationPartnershipProgram {
	...
	public RegionalConservationPartnershipProgram(WebDriver Idriver){
		this.driver=Idriver;
	}
...
count=count+1;
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/farmbill/rcpp/");
