...
public class RapidWatershedAssessment {
 ...
 static int count3=0;
	...
	public RapidWatershedAssessment(WebDriver Idriver){
		this.driver=Idriver;
	}
	//URL1 Elements
...
//URL2 methods
				driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/technical/dma/rwa/");
	      ...
	      if(httpURLConnect.getResponseCode()==HttpURLConnection.HTTP_NOT_FOUND)  
	       {
	         ...
	         //  System.out.println("No of URLs with HTTP-NOT_FOUND are"+count3);
