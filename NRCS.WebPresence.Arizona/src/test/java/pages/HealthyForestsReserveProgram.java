...
public class HealthyForestsReserveProgram {

	static WebDriver driver;
	
	public HealthyForestsReserveProgram (WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/easements/forests/");
