...
public class CIGProjectSearch {
	 ...
	 static WebDriver driver;
		...
		public CIGProjectSearch(WebDriver Idriver){
			this.driver=Idriver;
		}
		//URL1 Elements
		...
		//URL2 Elements
			...
			@FindBy(xpath="")
			static List<WebElement> SearchByGrantTypeURL2;
		 ...
		 public static 	List<String> SearchByGrantTypeArrayURL1 = null;
		
		 public static 	List<String> SearchByGrantTypeArrayURL2= null;
		 
		 
		 

		 public static 	List<String> GeneralTextSearchArrayURL1= null;

		 public static 	List<String> GeneralTextSearchArrayURL2= null;
		...
		count=count+1;
				...
				List<String> SearchByGrantTypeArrayURL1 = new ArrayList<String>();
				List<WebElement>SearchByGrantTypeURL1Ele=SearchByGrantTypeURL1;
				
				for(int i=0; i<=SearchByGrantTypeURL1Ele.size()-1; i++){
					System.out.println("Search By Grant Type are " + SearchByGrantTypeURL1Ele.get(i).getText());
				}
