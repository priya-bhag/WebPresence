...
public class WatershedSurveysandPlanning {

	static WebDriver driver;
	
	public WatershedSurveysandPlanning(WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/planning/wsp/");
