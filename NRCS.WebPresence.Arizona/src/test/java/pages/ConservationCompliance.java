...
public class ConservationCompliance {
	...
	public ConservationCompliance(WebDriver Idriver){
		this.driver=Idriver;
	}
	...
	//URL2 Elements
		...
		@FindBy(xpath=".//*[@id='layoutContainers']/div/table/tbody/tr/td/table/tbody/tr/td/div/section/div[2]/div[2]/div[2]/h2/a") static WebElement headingURL2;
	...
	int count=0;
		...
		String Link1 = LinksArrayURL1.toString();
		
	String var ="http://nrcsdak0021:10039";
		
	String s1="https://www.nrcs.usda.gov/";  
	

	 
String New_link = Link1.replaceAll("https://www.nrcs.usda.gov/","http://nrcsdak0021:10039");

String New_Link1=New_link.replaceAll("main/az/programs", "az/programs");
	
	System.out.println("Replaced individual links are " +New_Link1);
...
count1=count1+1;
		...
		System.out.println(LinksArrayURL2);
			...
			String NewLink2=LinksArrayURL2.toString();
			
			System.out.println("array values in 2 are "+NewLink2);
...
Boolean value3 =New_link.equals(NewLink2);
