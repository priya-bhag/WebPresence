...
public class WatershedOperations {

	static WebDriver driver;
	
	public WatershedOperations(WebDriver Idriver){
		this.driver=Idriver;
	}
...
//Arrays Comaparison
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl2()+"main/az/programs/planning/wo/");
