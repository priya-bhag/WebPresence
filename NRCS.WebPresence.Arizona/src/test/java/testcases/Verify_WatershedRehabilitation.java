...
public class Verify_WatershedRehabilitation {
...
WebDriver driver;
	...
	public void testHomePage(){
		...
		WatershedRehabilitation home =PageFactory.initElements(driver,WatershedRehabilitation.class);
	...
	WatershedRehabilitation.validateURL();
