...
import pages1.Missouri.EnvironmentalQualityIncentivesProgram1;
...
public class Verify_EnvironmentalQualityIncentivesProgram1 {
...

	{
		...
		driver.get(DataProviderFactory.getConfig().getApplicationUrl1() + "main/mo/programs/financial/eqip/");
